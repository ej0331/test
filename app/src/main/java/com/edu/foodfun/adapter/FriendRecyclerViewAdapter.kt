...
class FriendRecyclerViewAdapter(private val context: Context, private val data: List<String>): RecyclerView.Adapter<FriendRecyclerViewAdapter.ItemContactCardHolder>() {
